  ...
  : public RTC::DataFlowComponentBase
{
 ...
 protected:
  ...
  /*!
   * How long (in seconds) between updates to the map. Lowering
   * this number updates the occupancy grid more often, at the
   * expense of greater computational load.
   * - Name: map_update_interval map_update_interval
   * - DefaultValue: 5.0
   */
  ...
  /*!
   */
  RTC::CorbaPort m_mapServerClientPort;
